...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "نرد على جميع الاستفسارات خلال 24 ساعة كحد أقصى، وفي معظم الحالات نرد خلال ساعات قليلة. للاستفسارات العاجلة، يمكنك استخدام الدردشة المباشرة.",
      category: "technical",
      tags: ["دعم", "رد", "وقت"],
      helpful: 98,
      notHelpful: 6,
    ...
    },
    {
      ...
      answer: "معظم فروعنا تعمل من 7 صباحاً حتى 11 مساءً، مع فروع تعمل على مدار 24 ساعة في المواقع الرئيسية. يمكنك التحقق من ساعات العمل لكل فرع في التطبيق.",
      category: "services",
      tags: ["ساعات", "عمل", "فروع"],
      helpful: 123,
      notHelpful: 7,
    ...
    },
    {
      ...
      answer: "في حالة عدم الرضا عن الخدمة، يمكنك طلب استرداد المبلغ خلال 24 ساعة من الخدمة. اتصل بنا أو استخدم نموذج الشكاوى في التطبيق.",
      category: "payment",
